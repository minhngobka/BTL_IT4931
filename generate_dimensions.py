"""
Data Generator for Dimension Tables
====================================
Generates realistic dimension data to support the big data project:
- User dimension (demographics, segments, registration info)
