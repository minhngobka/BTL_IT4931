#!/bin/bash
# Step-by-Step Execution Guide for Big Data Project
# Run this script to execute the project phase by phase with guidance
...
echo -e "${BLUE}=========================================="
echo "Big Data Project - Step by Step Guide"
echo -e "==========================================${NC}"
echo ""
...
echo "  - user_dimension.csv"
echo "  - product_catalog.csv (enhanced)"
echo "  - category_hierarchy.csv"
echo ""
